                  ...
                  <tbody v-if="this.posts.length != 0">
                    <tr v-for="(post, index) in this.posts" :key="index">
                        ...
                        <td class="align-middle text-center text-sm">
                          <span v-if="post.status == 1" class="badge badge-sm bg-gradient-success">Published</span>
                          <span v-else class="badge badge-sm bg-gradient-secondary">Not published</span>
                        </td>
